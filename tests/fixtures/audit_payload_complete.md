...
| batch column | confounding | separates condition |
| --- | --- | --- |
| batch | 0.31 | yes |
...
| flags | batch_separates_condition |
...
| real split percentile in permutations | 97.5 |
