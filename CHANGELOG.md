...
- Added: demonstrations under `demo/` on public datasets outside the frozen Phase 0 list
  (Kang et al. 2018, stopped by the design gate as a paired design; a two-arm run on an
  unpaired dataset), generated by `scripts/demo_*.py`; labelled demonstrations outside the
