...
>
> Every number produced under this protocol is still synthetic; the v0.1.0 demonstrations under
> `demo/` are real public data outside the protocol and are labelled so.
